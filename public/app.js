document.addEventListener('DOMContentLoaded', () => {
    ...
    const lightLayout = {
        ...
        font: { color: '#475569', family: 'Outfit, sans-serif' },
    ...
    async function updateDashboard() {
        ...
        try {
            ...
            headerStatus.style.color = '#475569'; // Default subtitle color
    ...
    function clearDashboard() {
        ...
        // Purge charts
        const charts = ['trend-chart', 'pie-chart', 'bus-bar-chart', 'vi-scatter-chart', 'freq-hist-chart', 
    ...
    function updateCharts(records, trendParamName) {
        ...
        // --- Row 0: Trend Chart ---
        const trendTrace = {
            x: records.map(r => r.Record_Index),
            y: records.map(r => r[trendParamName]),
            type: 'scatter',
            mode: 'lines',
            name: trendParamName,
        ...
        const faultTrace = {
            x: faults.map(r => r.Record_Index),
            y: faults.map(r => r[trendParamName]),
            type: 'scatter',
            mode: 'markers',
            name: 'Fault',
            marker: { color: 'rgba(239, 68, 68, 0.7)', size: 5 }
        };

        // Determine if we should use darkLayout or lightLayout based on what exists
        const currentLayout = typeof lightLayout !== 'undefined' ? lightLayout : (typeof darkLayout !== 'undefined' ? darkLayout : {});

        Plotly.newPlot('trend-chart', [trendTrace, faultTrace], {
            ...currentLayout,
            hovermode: 'x unified',
            legend: { orientation: 'h', y: 1.1 },
            xaxis: { ...currentLayout.xaxis, title: 'Record Index' },
            yaxis: { ...currentLayout.yaxis, title: trendParamName },
        ...
        Plotly.newPlot('pie-chart', [pieTrace], { ...lightLayout, showlegend: true, legend: {orientation: 'h', y: -0.2}, margin: { t: 30, b: 30, l: 30, r: 30 } });
        ...
        }], { ...lightLayout, xaxis: { ...lightLayout.xaxis, title: 'Voltage (pu)' }, yaxis: { ...lightLayout.yaxis, title: 'Current (pu)' }, margin: {l: 50, r: 20, t: 30, b: 40} });
        ...
        ], { ...lightLayout, barmode: 'overlay', xaxis: { ...lightLayout.xaxis, title: 'Frequency (Hz)' }, yaxis: { ...lightLayout.yaxis, title: 'Count' }, margin: {l: 50, r: 20, t: 30, b: 40}, legend: {orientation: 'h', y: 1.1} });
        ...
        ], { ...lightLayout, barmode: 'overlay', xaxis: { ...lightLayout.xaxis, title: 'Voltage_Angle (°)' }, yaxis: { ...lightLayout.yaxis, title: 'Count' }, margin: {l: 50, r: 20, t: 30, b: 40}, legend: {orientation: 'h', y: 1.1} });
        ...
        ], { ...lightLayout, barmode: 'overlay', xaxis: { ...lightLayout.xaxis, title: 'Current_Angle (°)' }, yaxis: { ...lightLayout.yaxis, title: 'Count' }, margin: {l: 50, r: 20, t: 30, b: 40}, legend: {orientation: 'h', y: 1.1} });
        ...
        ], { ...lightLayout, xaxis: { ...lightLayout.xaxis, title: 'Record Index' }, yaxis: { ...lightLayout.yaxis, title: 'Apparent Power (pu)' }, margin: {l: 50, r: 20, t: 30, b: 40}, legend: {orientation: 'h', y: 1.1} });
        ...
        ], { ...lightLayout, barmode: 'overlay', xaxis: { ...lightLayout.xaxis, title: 'PF Angle (°)' }, yaxis: { ...lightLayout.yaxis, title: 'Count' }, margin: {l: 50, r: 20, t: 30, b: 40}, legend: {orientation: 'h', y: 1.1} });
        ...
        }], { ...lightLayout, xaxis: { ...lightLayout.xaxis, title: 'Active Power P (pu)' }, yaxis: { ...lightLayout.yaxis, title: 'Reactive Power Q (pu)' }, margin: {l: 50, r: 20, t: 30, b: 40} });
        ...
        ], { ...lightLayout, barmode: 'overlay', xaxis: { ...lightLayout.xaxis, title: 'Power Factor' }, yaxis: { ...lightLayout.yaxis, title: 'Count' }, margin: {l: 50, r: 20, t: 30, b: 40}, legend: {orientation: 'h', y: 1.1} });
    }
    ...
    function updateScorecard(scorecard) {
        ...
        ], { ...lightLayout, barmode: 'stack', xaxis: { ...lightLayout.xaxis, title: 'Bus ID', type: 'category' }, yaxis: { ...lightLayout.yaxis, title: 'Record Count' }, margin: {l: 50, r: 20, t: 30, b: 40}, legend: {orientation: 'h', y: 1.1} });
        ...
        Plotly.newPlot('scorecard-chart', [{
            x: buses, y: faultRates, type: 'bar', marker: { color: colors, colorbar: {title: 'Fault %', tickvals: [40, 45, 50, 55], tickcolor: '#0f172a'} },
            text: faultRates.map(r => (r < 45 ? 'Healthy' : (r <= 50 ? 'Warning' : 'Critical'))), textposition: 'outside', textfont: { color: '#475569' }
        }], {
            ...lightLayout, xaxis: { ...lightLayout.xaxis, title: 'Bus ID', type: 'category' }, yaxis: { ...lightLayout.yaxis, title: 'Fault Rate (%)' }, margin: {l: 50, r: 20, t: 30, b: 40},
            shapes: [
